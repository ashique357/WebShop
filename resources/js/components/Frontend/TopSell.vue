<template>
   ...
   <div class="ps-container">
      <div class="ps-section__header mb-50">
         <h3 class="ps-section__title" data-mask="TOP SELL">- Top Seller</h3>
                  ...
                  <div class="grid-item__content-wrapper">
                     <div class="ps-shoe mb-30">
                        <div class="ps-shoe__thumbnail">
                           ...
                           <a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img :src="feature.preview_image" alt=""><a class="ps-shoe__overlay" href="#"></a>
                        </div>
                        <br>
                        <div class="ps-shoe__content">
                           ...
                           <div class="ps-shoe__detail">
                              <a class="ps-shoe__name" href="#">{{feature.name}}</a>
                              <p class="ps-shoe__categories"><a href="#">{{feature.category_name}}</a></p>
                              <span class="ps-shoe__price">
                              <del>£{{feature.price}}</del> £ {{feature.discount_price}}</span>
                           </div>
                        </div>
                     </div>
                  </div>
...
<script>
    ...
    const TOP_SELL_URL="/api/frontend/products/top-sell";
