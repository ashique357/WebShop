...
<div class="card shadow mb-4">
      <div class="card-header py-3">
         ...
         <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm pull-right" @click="openModal('#createModal')"><i class="fas fa-plus fa-sm text-white-50"></i> Add Permission</a>
      </div>
      <div class="card-body">
            ...
            <div class="row">
               <div class="col-sm-12">
                  <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                     ...
                     <tbody>
                        <tr role="row" v-for="(permission , index) in paginatedData" :key="index">
                           <td>{{index+1}}</td>
                           ...
                           <td>{{permission.status}}</td>
                            <td>  
                                <div class="form-group">
                                 <a class="btn btn-sm btn-primary" title="View" @click="showModal('#showModal',permission)"><i class="fas fa-eye"></i></a>
                                 <a class="btn btn-sm btn-secondary" title="Edit" @click="editModal('#editModal',permission)"><i class="fas fa-edit"></i></a>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content" style="width:130%">
               <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Add Permission <strong></strong></h5>
               ...
               <div class="modal-body">
                  <div class="r;ow">
                     ...
                     <div class="col-md-12">
                        ...
                        <input type="text" v-model="store.slug" id="slug1" class="form-control">
                     </div>
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        ...
                        <select name="" id="type" class="form-control" v-model="store.type">
                            ...
                            <option value="2">Single Menu</option>
                        </select>
                     </div>
      ...
      <div class="modal fade" id="showModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content" style="width:130%">
               <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Permission Details<strong></strong></h5>
                  <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span>
                  </button>
               </div>
      ...
      <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content" style="width:130%">
               <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Edit Permission Details<strong></strong></h5>
                  <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span>
                  </button>
               </div>
            <form action="" method="Post" @submit.prevent="updatePermission(show)">
               <div class="modal-body">
                  <div class="row">
                     <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        <label for=""><b>Type:</b></label>
                        <select name="" id="type" class="form-control" v-model="show.type">
                            <option value="1">Group Menu</option>
                            <option value="2">Single Menu</option>
                        </select>
                     </div>
