...
<div class="card shadow mb-4">
      <div class="card-header py-3">
         ...
         <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm pull-right" @click="openModal('#createModal')"><i class="fas fa-plus fa-sm text-white-50"></i> Add Variation Option</a>
      </div>
      <div class="card-body">
            ...
            <div class="row">
               <div class="col-sm-12">
                  <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                     ...
                     <tbody>
                        <tr role="row" v-for="(option , index) in paginatedData" :key="index">
                           <td v-text="index+1"></td>
                           <td v-text="option.name"></td>
                            <td v-text="option.var_id"></td>
                            <td> 
                              <div class="form-group">
                                 <a class="btn btn-sm btn-primary" title="View" @click="showModal('#showModal',option)"><i class="fas fa-eye"></i></a>
                                 <a class="btn btn-sm btn-secondary" title="Edit" @click="editModal('#editModal',option)"><i class="fas fa-edit"></i></a>
      ...
      <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            ...
            <form action="" method="Post" @submit.prevent="createVarOptionData(store)">
               <div class="modal-body">
                  <div class="row">
                    <div class="col-md-12">
                        <label for=""><b>Variation Option name:</b></label>
                        <input type="text" v-model="store.name" id="name1" class="form-control">
                     </div>

                    <div class="col-md-12">
                        <label for=""><b>Select Variation:</b></label>
                        <select name="" id="" class="form-control" v-model="store.var_id">
      ...
      <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog" role="document">
            ...
            <form action="" method="Post" @submit.prevent="updateVarOptionData(show)">
               <div class="modal-body">
                  <div class="row">
                     <div class="col-md-12">
                        <label for=""><b>Variation name:</b></label>
                    ...
                    <div class="col-md-12">
                        <label for=""><b>Select Variation:</b></label>
                        <select name="" id="" class="form-control" v-model="show.var_id">
                            <option disabled>Select Variation</option>
                            <option v-for="(va,index) in variations" :key="index" :value="index">{{va}}</option>
                        </select>
                    </div>
...
const INDEX_URL="/api/admin/variation/option/index";
const STORE_URL="/api/admin/variation/option/store";
const UPDATE_URL="/api/admin/variation/option/update";
export default {
    mixins: [mixin],
    ...
    data(){
        return{
            ...
            {label: 'Variation Id', name: 'var_id' },
        ],
        show:[],
        store:{
           name:'',
    ...
    methods: {
      ...
      updateVarOptionData(data) {
        this.updateData(UPDATE_URL,data);
      },

      createVarOptionData(store) {
        this.store.name=store.name;
        this.store.var_id=store.var_id;
