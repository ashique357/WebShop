...
<script type="text/javascript" src="{{env('PUBLIC_PATH')}}/Frontend/plugins/jquery.matchHeight-min.js"></script>
<script type="text/javascript" src="{{env('PUBLIC_PATH')}}/Frontend/plugins/slick/slick/slick.min.js"></script>
...
<script type="text/javascript" src="{{env('PUBLIC_PATH')}}/Frontend/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="{{env('PUBLIC_PATH')}}/Frontend/plugins/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="{{env('PUBLIC_PATH')}}/Frontend/plugins/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script type="text/javascript" src="{{env('PUBLIC_PATH')}}/Frontend/plugins/revolution/js/extensions/revolution.extension.actions.min.js"></script>
